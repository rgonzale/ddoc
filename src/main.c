...
/*
 * sort Domain function, only compares the elements before it
 */
...
/*
 * sort Request function, only compares the elemnts before it
 */
...
*/
	...
	wresize(p1domains, totalrowsp1 * 2, columns - 3);
